...
abstract class ExpressionNode extends Node {
   ...
   * The method is overridden for plain references to check for undefined. The reason is to support
   * Velocity's idiom {@code #if ($var)}, which is not an error if {@code $var} is undefined.
   */

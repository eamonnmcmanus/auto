...
## How to use AutoValue<a name="howto"></a>
...
### In your value class<a name="example_java"></a>
...
### What's going on here?<a name="whats_going_on"></a>
...
## Why should I use AutoValue?<a name="why"></a>

See [Why AutoValue?](why.md).

## How do I...<a name="more_howto"></a>
